...
function createFilmsTemplate({filmList, topRatedFilmList, mostCommentedFilmList}) {
  return (
    `<section class="films">${filmList}${topRatedFilmList}${mostCommentedFilmList}</section>`
  );
}

function createFilmListTemplate({heading, films, showMoreButton}, isExtra = false) {
  return (
...
function createFilmListShowMoreTemplate() {
  return (
...
function render(targetElement, element, position = `beforeend`) {
...
render(mainElement, createFilmsTemplate({
  filmList: createFilmListTemplate({
    ...
    films: createFilmCardTemplate().repeat(FILM_CARDS_COUNT),
    showMoreButton: createFilmListShowMoreTemplate()
  }),
  topRatedFilmList: createFilmListTemplate({heading: `Top rated`, films: createFilmCardTemplate().repeat(EXTRA_FILM_CARDS_COUNT)}, true),
  mostCommentedFilmList: createFilmListTemplate({heading: `Most commented`, films: createFilmCardTemplate().repeat(EXTRA_FILM_CARDS_COUNT)}, true)
}));
